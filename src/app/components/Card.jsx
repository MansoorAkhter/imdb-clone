...
const Card = ({ result }) => {
    return <div className="cursor-pointer sm:p-3 sm:hover:shadow-slate-400 sm:shadow-md rounded-lg sm:border sm:border-slate-400 sm:m-2 transition-shadow duration-200 group">
        ...
        <Link href={`/movie/${result.id}`}>
            ...
            <div className="p-2">
                ...
                <p className="flex items-center">
                    {result.release_date || release.first_air_date}
